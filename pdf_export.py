...
TITLE_STYLE = ParagraphStyle(
    "NovaTitle", parent=_styles["Title"], textColor=colors.HexColor("#4834d4")
)
SUBTITLE_STYLE = ParagraphStyle(
    "NovaSubtitle", parent=_styles["Normal"], textColor=colors.HexColor("#666666"), spaceAfter=14
)
H1_STYLE = ParagraphStyle(
    "NovaH1", parent=_styles["Heading1"], textColor=colors.HexColor("#4834d4"),
    spaceBefore=14, spaceAfter=6,
)
H2_STYLE = ParagraphStyle(
    "NovaH2", parent=_styles["Heading2"], textColor=colors.HexColor("#6C5CE7"),
    spaceBefore=10, spaceAfter=4,
)
BODY_STYLE = ParagraphStyle("NovaBody", parent=_styles["Normal"], spaceAfter=6, leading=15)
BULLET_STYLE = ParagraphStyle(
    "NovaBullet", parent=_styles["Normal"], leftIndent=14, spaceAfter=3, leading=14
)
